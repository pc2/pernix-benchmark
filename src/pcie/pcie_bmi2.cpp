...
struct Bmi2Compressor { template <std::uint8_t W, typename T> int operator()(const T* i,T s,std::uint8_t* o) const { return pernix::mm256_compress_block_bmi2<W,64>(i,s,o); } };
struct Bmi2Decompressor { template <std::uint8_t W, typename T> int operator()(const std::uint8_t* i,T s,T* o) const { return pernix::mm256_decompress_block_bmi2<W,true,64>(i,s,o); } };
